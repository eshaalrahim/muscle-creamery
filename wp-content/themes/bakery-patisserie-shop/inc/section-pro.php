 ...
 * @access public
 */
class Bakery_Patisserie_Shop_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'bakery-patisserie-shop';
...
class bakery_patisserie_shop_Button extends WP_Customize_Section {
